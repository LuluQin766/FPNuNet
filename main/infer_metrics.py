"""
Inference Metrics for Instance Segmentation

This module contains utility functions for computing instance segmentation evaluation metrics.
The code is sourced from multiple open-source projects, with proper attribution.

Code Source Attribution:
=======================

1. PanNuke Metrics Functions (Original Implementation):
   Source: https://github.com/TissueImageAnalytics/PanNuke-metrics
   Functions: get_fast_pq, binarize, get_tissue_idx

2. SRSA-Net Metrics Functions (Derived from PanNuke):
   Source: https://github.com/RanrWang/SRSA-Net/blob/main/utils/stats_utils.py
   Functions: get_fast_aji, get_fast_aji_plus, get_fast_dice_2, 
              get_dice_1, get_dice_2, remap_label, pair_coordinates, iou_metric
"""
...
def remap_label(pred, by_size=False):
    ...
    Source: SRSA-Net (https://github.com/RanrWang/SRSA-Net)
...
def binarize(x):
    ...
    Source: PanNuke-metrics (https://github.com/TissueImageAnalytics/PanNuke-metrics)
    
    Args:
        x: B*B*C (for PanNuke 256*256*5)
    Returns:
...
def get_tissue_idx(tissue_indices, idx):
    """
    Get tissue index for a given index.
...
def get_fast_pq(true, pred, match_iou=0.5):
    ...
    Source: PanNuke-metrics (https://github.com/TissueImageAnalytics/PanNuke-metrics)
    Note: This is the original implementation from PanNuke, which was the first
          to propose this fast PQ metric implementation.
...
# ============================================================================
# SRSA-Net Metrics Functions
# Source: https://github.com/RanrWang/SRSA-Net/blob/main/utils/stats_utils.py
# Note: SRSA-Net's implementation is derived from PanNuke's original work.
#       PanNuke was the first to propose the fast PQ metric implementation.
# ============================================================================
...
def iou_metric(y_true_in, y_pred_in):
    """
    Compute IoU metric for binary segmentation.
